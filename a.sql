...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2021 at 08:21 AM
...
(22, '11223344555xx', 'megumin', 'adadsgtev', '2021-03-17', 10, 'S1', 'zxczxczxczxc', '1.png');
...
(1, 'STMIK METRO', 'Sekolah Tinggi Manajemen Informatika dan Komputer (STMIK) Dharma Wacana Metro berdiri tanggal 23 Agustus 2000, berdasarkan SK Dikti 174/D/O/2000, dengan tiga Program Studi berada di dalamnya.  Drs. Ponco Heru Susanto selaku anak menantu pendiri Yayasan Dharma Wacana diberi kepercayaan untuk mengelola STMIK Dharma Wacana. Yang selanjutnya disebut Pengelola Pertama. Dikarenakan adanya reorganisasi, Pada tanggal 20 Agustus 2002 Ir. Mugni Kusniady, M.S. diangkat sebagai Ketua STMIK periode 2002-2006. Kemudian pada tahun 2004 STMIK Dharma Wacana di Ketuai oleh Ir. Heru Widodo, M.Msi. ', 'STMIK Dharma Wacana adalah menjadi institusi akademik terdepan berbasis teknologi informasi dan komunikasi yang diakui ditingkat nasional.', 'Berdasarkan visi tersebut di atas, maka misi STMIK Dharma Wacana adalah sebagai berikut: a.	Menyelenggarakan pendidikan bermutu tinggi dibidang ilmu komputer dan teknologi informasi bagi masyarakat sebagai sarana untuk menghasilkan lulusan yang berkualitas, profesional, kompeten dan sesuai dengan saat ini dan akan datang. b.	Memberikan kontribusi dalam pembangunan yang berkesinambungan dan meningkatkan kemakmuran masyarakat.', 'https://instagram.com', 'https://facebook.com', '082266666666', 'stmik_metro@gmail.com', 'Jl. Kenanga No. 3 Mulyojati 16C Metro Barat Kota Metro. ', 'j.png', 'j.png');
...
(7, 'testing aja', '<p>yow ini testing aja skalian untuk bantuin adek gw yang namanya sri puspita dewi</p>', '2021-03-01');
...
INSERT INTO `ppdb` (`ppdb_id`, `nisn`, `password`, `nama_lengkap`, `tgl_lahir`, `tmp_lahir`, `jenkel`, `asal_sekolah`, `nama_ayah`, `nama_ibu`, `alamat`, `no_telp`, `jurusan`, `foto_siswa`, `foto_ijazah`, `tgl_daftar`, `agama`, `jenis_tinggal`, `transportasi`, `status`, `pelatihan`, `nilai`) VALUES
(26, '150299', '$2y$10$VVQy3b5aiKy5MMki3BT/3O31ifK3.DwsdGL.xMMcZ5hZYskpm/Joq', 'Prayogi Muhammad', '1999-02-15', 'Palembang', 'Laki-Laki', 'Demo', 'aad', 'dadd', 'Roppongi, Minato, Tokyo 106-0032', '082269696969', 'IPA', 'Prayogi Muhammad_150299.jpeg', 'Ijazah_150299.png', '2021-02-13', 'Islam', 'Bersama Orangtua', 'Motor', 'Lulus', '10', 80),
(27, '12345', '$2y$10$N.VfsNoRoLSQPOsHvHSmv.JDJFbexjqfErUn8nJNwXq0ZmL/S7Af2', 'sfaasf', '2021-03-26', 'sdafdsfdas', 'Laki-Laki', 'cxvzxv', 'dsfsd', 'fff', 'sdfsd', '051265461313', 'IPA', 'default.png', 'default.png', '2021-03-02', 'Islam', 'Kos', 'Mobil', 'Lulus', 'aaah', 0),
(28, '123451', '$2y$10$.bRXU6E3YA9.z7gArv3/Y.8APbVviDbrorIOJYUwwb96e8Y3somzm', 'asdasd', '2021-03-10', 'asdasdas', 'Perempuan', 'cxvzxva', 'dsfsda', 'asdas', 'sapporoa', '05126545', 'IPA', 'default.png', 'default.png', '2021-03-06', 'Katolik', 'Bersama Saudara', 'Motor', 'Lulus', '10', 0);
...
(22, 'levi', 'Levi ackerman', 'levi@gmail.com', '$2y$10$jozEw/RcyqE44PUG1HbfmOzl7OMjCwiTKZ8WYYrDd2YSReCVbJk4y', 'default.png', '1', 1);
...
--
ALTER TABLE `guru`
  MODIFY `guru_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `ppdb`
  MODIFY `ppdb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
